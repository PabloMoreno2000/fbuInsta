...
**Instapp** is a photo sharing app using Parse as its backend.
...
Areas of the assignment to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Check the different ways to implement the same functionalities
